 ...
 */
public class FilterQuestionsActivity extends AppCompatPreferenceActivity {
    /**
    ...
    public static class CategoryPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference("selected_category"));
        }
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            int id = item.getItemId();
            if (id == android.R.id.home) {
                startActivity(new Intent(getActivity(), FilterQuestionsActivity.class));
                return true;
            }
    ...
    public static class DifficultyPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            //bindPreferenceSummaryToValue(findPreference("example_text"));
            bindPreferenceSummaryToValue(findPreference("selected_difficulty_level"));
        }
